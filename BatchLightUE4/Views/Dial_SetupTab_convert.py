...
class Ui_DialogSetupProject(object):
    ...
    def retranslateUi(self, DialogSetupProject):
        ...
        self.ProjectTreeLevels.headerItem().setText(1, _translate("DialogSetupProject", "Names"))
        self.ProjectTreeLevels.headerItem().setText(2, _translate("DialogSetupProject", "Paths"))
