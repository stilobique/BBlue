...
class Ui_DialogSetupProject(object):
    def setupUi(self, DialogSetupProject):
        ...
        self.ue4_path_edit = QtWidgets.QPushButton(self.groupBox)
        self.ue4_path_edit.setObjectName("ue4_path_edit")
        self.gridLayout_3.addWidget(self.ue4_path_edit, 0, 2, 1, 1)
        ...
        self.sub_folder_edit = QtWidgets.QPushButton(self.groupBox)
        self.sub_folder_edit.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Resources/Icons/sync.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.sub_folder_edit.setIcon(icon)
        self.sub_folder_edit.setObjectName("sub_folder_edit")
        self.gridLayout_3.addWidget(self.sub_folder_edit, 2, 2, 1, 1)
        ...
        self.ProjectTreeLevels = QtWidgets.QTreeView(self.groupBox_2)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Resources/Icons/package.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_project, icon1, "")
        ...
        self.sc_groupBox_soft = QtWidgets.QGroupBox(self.tab_sc)
        self.sc_groupBox_soft.setObjectName("sc_groupBox_soft")
        self.gridLayout_10 = QtWidgets.QGridLayout(self.sc_groupBox_soft)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.gridLayout_9 = QtWidgets.QGridLayout()
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.softwares_comboBox = QtWidgets.QComboBox(self.sc_groupBox_soft)
        ...
        self.softwares_label = QtWidgets.QLabel(self.sc_groupBox_soft)
        ...
        self.verticalLayout_5.addWidget(self.sc_groupBox_soft)
        self.sc_groupBox_setup = QtWidgets.QGroupBox(self.tab_sc)
        self.sc_groupBox_setup.setObjectName("sc_groupBox_setup")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.sc_groupBox_setup)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.path_sc_label = QtWidgets.QLabel(self.sc_groupBox_setup)
        ...
        self.gridLayout_7.addWidget(self.path_sc_label, 0, 0, 1, 1)
        self.path_sc_text = QtWidgets.QLineEdit(self.sc_groupBox_setup)
        self.path_sc_text.setEnabled(False)
        self.path_sc_text.setObjectName("path_sc_text")
        self.gridLayout_7.addWidget(self.path_sc_text, 0, 1, 1, 1)
        self.path_sc_edit = QtWidgets.QPushButton(self.sc_groupBox_setup)
        self.path_sc_edit.setEnabled(False)
        self.path_sc_edit.setObjectName("path_sc_edit")
        self.gridLayout_7.addWidget(self.path_sc_edit, 0, 2, 1, 1)
        self.user_label = QtWidgets.QLabel(self.sc_groupBox_setup)
        ...
        self.gridLayout_7.addWidget(self.user_label, 1, 0, 1, 1)
        self.user_text = QtWidgets.QLineEdit(self.sc_groupBox_setup)
        self.user_text.setEnabled(False)
        self.user_text.setObjectName("user_text")
        self.gridLayout_7.addWidget(self.user_text, 1, 1, 1, 1)
        self.password_label = QtWidgets.QLabel(self.sc_groupBox_setup)
        ...
        self.gridLayout_7.addWidget(self.password_label, 2, 0, 1, 1)
        self.password_text = QtWidgets.QLineEdit(self.sc_groupBox_setup)
        self.password_text.setEnabled(False)
        self.password_text.setObjectName("password_text")
        self.gridLayout_7.addWidget(self.password_text, 2, 1, 1, 1)
        self.verticalLayout_5.addWidget(self.sc_groupBox_setup)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Resources/Icons/git-branch.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_sc, icon2, "")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Resources/Icons/globe.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_network, icon3, "")
        self.verticalLayout.addWidget(self.tabWidget)
        self.buttonBox = QtWidgets.QDialogButtonBox(DialogSetupProject)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Close|QtWidgets.QDialogButtonBox.Open|QtWidgets.QDialogButtonBox.RestoreDefaults|QtWidgets.QDialogButtonBox.Save)
    ...
    def retranslateUi(self, DialogSetupProject):
        ...
        self.ue4_path_edit.setText(_translate("DialogSetupProject", "Select Engine"))
        ...
        self.project_file_edit.setText(_translate("DialogSetupProject", "Game Project"))
        ...
        self.sc_groupBox_soft.setTitle(_translate("DialogSetupProject", "Source Control Software"))
        ...
        self.sc_groupBox_setup.setTitle(_translate("DialogSetupProject", "Sotware Setup"))
