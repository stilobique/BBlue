...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuLoad = QtWidgets.QMenu(self.menu_File)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("Resources/Icons/link-external.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("Resources/Icons/file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNew_Setup.setIcon(icon8)
        self.actionNew_Setup.setObjectName("actionNew_Setup")
        self.actionExit = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("Resources/Icons/sign-out.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionExit.setIcon(icon9)
        self.actionExit.setObjectName("actionExit")
        self.actionProject = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("Resources/Icons/package.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionProject.setIcon(icon10)
        self.actionProject.setObjectName("actionProject")
        self.actionNetworks = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("Resources/Icons/globe.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNetworks.setIcon(icon11)
        self.actionNetworks.setObjectName("actionNetworks")
        self.actionCSV = QtWidgets.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("Resources/Icons/git-branch.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCSV.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("Resources/Icons/issues-closed.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout.setIcon(icon13)
        self.actionAbout.setObjectName("actionAbout")
        self.actionShortcut = QtWidgets.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("Resources/Icons/pencil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionSave_Copy.setIcon(icon14)
        ...
        self.menu_File.addAction(self.actionNew_Setup)
        self.menu_File.addAction(self.actionSave_Copy)
