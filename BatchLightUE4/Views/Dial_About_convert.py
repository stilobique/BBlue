...
# Form implementation generated from reading ui file 'Dial_About.ui'
#
...
class Ui_Help(object):
    def setupUi(self, Help):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Resources/issues-closed.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../Resources/pencil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
